...
## Project Structure
    ...
    ├── testapiautosettings_55198  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_55198`
...
2. Clone this repo and `cd testapiautosettings_55198`
